...
import com.diycomputerscience.minesweeper.model.jdbc.JDBCPersistenceStrategy;
...
public class JDBCPersistenceStrategyTest {
	...
	public void testLoad() throws Exception {
		BoardDo expectedBoard = new BoardDo();
		BoardDao mockBoardDao = EasyMock.createMock(BoardDao.class);
		...
		BoardDo board = this.persistenceStrategy.load();
